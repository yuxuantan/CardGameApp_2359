    ...
    if (this.state.isFlipped) {
      render_side = (
        ...
        >
          {/* {c[1]} */}
          {/* Back Side */}
          <View style={S.numberSide}>
            <Text style={S.numberText}>{this.props.cardNumber}</Text>
          </View>
        </Back>
      );
    } else {
...
FlipCard.propTypes = {
  ...
  // flipBackAfter: PropTypes.number,
